...
full_model <- glm(price ~ depth*height*width+other_colors+category, data = train_data, 
...
train_data<-train_data %>%
  mutate(depth_width=depth*width)
model1 <- glm(price ~ depth_width+height, data = train_data, 
                            family = binomial(link = "logit"))
